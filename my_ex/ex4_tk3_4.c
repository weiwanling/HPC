/*
 * gcc -g -Wall -lm -fopenmp -o ex4_tk3_4 ex4_tk3_4.c && ./ex4_tk3_4 4
 */
#include <stdio.h>
#include<stdlib.h>
#include<math.h>
...
void Trap(double a,double b,int n,int thread_count,double* global_result)
{
...
int main(int argc,char* argv[])
{
   ...
   Trap(a,b,n,thread_count,&global_result);
