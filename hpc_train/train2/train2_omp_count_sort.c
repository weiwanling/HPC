/* File:      train2_omp_count_sort.c
 * Purpose:   Implementation of parallel count sort
 *
 * Compile:   gcc -g -Wall -fopenmp -o train2_omp_count_sort train2_omp_count_sort.c
 *
 *                 
 * Run:      ./train2_omp_count_sort <thread_count> <n>
 *            ./train2_omp_count_sort  4 100
 * Input:   none
